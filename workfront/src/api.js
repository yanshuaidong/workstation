...
// assistant 辅助决策接口
export const getAssistantSignalsApi = `${BASE_URL_API_A}/assistant/signals`;
export const getAssistantOperationsApi = `${BASE_URL_API_A}/assistant/operations`;
export const getAssistantPositionsApi = `${BASE_URL_API_A}/assistant/positions`;
export const getAssistantPositionsHistoryApi = `${BASE_URL_API_A}/assistant/positions/history`;
